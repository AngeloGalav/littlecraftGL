...
void Cube::initCube(){
	...
	faces[1].Model = translate(faces[1].Model, vec3(1.0f, 0.0, -1.0f));
	...
	faces[2].Model = translate(faces[2].Model, vec3(0.0, 0.0, -2.0f));

	faces[3].crea_VAO_Vector();
	faces[3].Model = mat4(1.0);
	faces[3].Model = scale(faces[3].Model, vec3(2.0f, 2.0f, 2.0f));
	faces[3].Model = translate(faces[3].Model, vec3(-1.0f, 0.0, -1.0f));
	...
	faces[4].Model = translate(faces[4].Model, vec3(0, 1.0f, -1.0f));
	...
	faces[5].Model = translate(faces[5].Model, vec3(0.0, -1.0f, -1.0f));
